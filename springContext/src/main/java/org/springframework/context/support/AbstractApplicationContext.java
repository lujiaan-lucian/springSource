...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	 ...
	 */
	/*xxx: 容器中，lifecycleProcessor的bean的名称*/
	 ...
	 */
	/*xxx: 容器中，applicationEventMulticaster的bean的名称 */
	...
	/*xxx: 当前上下文使用的 资源句柄解析器*/
	private ResourcePatternResolver resourcePatternResolver;

	/** LifecycleProcessor for managing the lifecycle of beans within this context. */
	@Nullable
    /*xxx: 当前上下文使用的 lifecycleProcessor*/
	private LifecycleProcessor lifecycleProcessor;

	/** MessageSource we delegate our implementation of this interface to. */
	@Nullable
    /*xxx: 当前上下文使用的 messageSource */
	...
	@Nullable
    /*xxx: 本地注册的，refresh方法之前调用的 应用监听器*/
	private Set<ApplicationListener<?>> earlyApplicationListeners;

	/** ApplicationEvents published before the multicaster setup. */
	@Nullable
    /*xxx: 再事件发布器设置前需要发布的事件*/
	 ...
	 */ /*xxx: 默认的资源句柄解析器为 PathMatchingResourcePatternResolver */
	...
	@Override
	/*xxx: 上下文是否正在运行的判定方法，通过判断 生命周期处理器的状态进行判断 */
