...
public class BeanDefinitionParserDelegate {
	...
	/*xxx: 文档定义信息，依赖于 spirng-schema.xsi*/
	 ...
	 */
	/*xxx: 存储所有使用过的bean名称，以便我们可以在每个bean元素的基础上强制唯一性。
	   重复的bean id或者名称不能存在于同一级别的bean元素嵌套中，但可以跨级别重复。*/
	 ...
	 */
	/*xxx: 解析beanDefinition属性*/
	public AbstractBeanDefinition parseBeanDefinitionAttributes(Element ele, String beanName,
			@Nullable BeanDefinition containingBean, AbstractBeanDefinition bd) {
		//判断是否有singleton属性，新版本要用scope属性
		...
		//解析scope属性
			...
			//在嵌入beanDifinition情况下 且没有单独指定scope属性，则使用父类默认的属性
		...
		/*xxx: 如果当前元素，指定了 depends-on属性，则进行设置*/
